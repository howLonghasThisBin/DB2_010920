...
CREATE TABLE "010920".CLASS (CLASS_CODE varchar(5),CRS_CODE varchar(10),CLASS_SECTION varchar(2),CLASS_TIME varchar(20),CLASS_ROOM varchar(8),PROF_NUM float(8));
...
/* -"010920".COURSE- */
CREATE TABLE "010920".COURSE (CRS_CODE varchar(10),DEPT_CODE varchar(10),CRS_DESCRIPTION varchar(35),CRS_CREDIT float(8));
...
/* -"010920".DEPARTMENT- */
CREATE TABLE "010920".DEPARTMENT (DEPT_CODE varchar(10),DEPT_NAME varchar(30),SCHOOL_CODE varchar(8),EMP_NUM int,DEPT_ADDRESS varchar(20),DEPT_EXTENSION varchar(4));
...
/* -"010920".EMPLOYEE- */
CREATE TABLE "010920".EMPLOYEE (EMP_NUM int,EMP_LNAME varchar(15),EMP_FNAME varchar(12),EMP_INITIAL varchar(1),EMP_JOBCODE varchar(5),EMP_HIREDATE timestamp,EMP_DOB timestamp);
...
/* -- */
CREATE TABLE "010920".ENROLL (CLASS_CODE varchar(5),STU_NUM int,ENROLL_GRADE varchar(50));
...
/* -TABLE- */
CREATE TABLE "010920".PROFESSOR (EMP_NUM int,DEPT_CODE varchar(10),PROF_OFFICE varchar(50),PROF_EXTENSION varchar(4),PROF_HIGH_DEGREE varchar(5));
...
/* -"010920".STUDENT- */
CREATE TABLE "010920".STUDENT (STU_NUM int,STU_LNAME varchar(15),STU_FNAME varchar(15),STU_INIT varchar(1),STU_DOB timestamp,STU_HRS int,STU_CLASS varchar(2),STU_GPA float(8),STU_TRANSFER numeric,DEPT_CODE varchar(18),STU_PHONE varchar(4),PROF_NUM int);
